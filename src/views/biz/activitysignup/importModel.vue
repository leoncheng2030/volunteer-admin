...
<script setup name="volActivitySignupImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return volActivitySignupApi
			.volActivitySignupImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		volActivitySignupApi.volActivitySignupDownloadTemplate().then((res) => {
