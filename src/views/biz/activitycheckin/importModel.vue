...
<script setup name="volActivityCheckinImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return volActivityCheckinApi
			.volActivityCheckinImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		volActivityCheckinApi.volActivityCheckinDownloadTemplate().then((res) => {
