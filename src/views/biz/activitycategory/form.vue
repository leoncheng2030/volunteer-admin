<template>
	<xn-form-container
		:title="formData.id ? '编辑活动分类' : '增加活动分类'"
		:width="700"
		v-model:open="open"
	...
	>
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
			<a-row :gutter="16">
				...
				<a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
					<a-form-item label="父分类ID：" name="parentId">
						<a-input v-model:value="formData.parentId" placeholder="请输入父分类ID" allow-clear />
					</a-form-item>
				</a-col>
				<a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
...
<script setup name="volActivityCategoryForm">
	...
	const onSubmit = () => {
		formRef.value
			...
			.then(() => {
				...
				volActivityCategoryApi
					.volActivityCategorySubmitForm(formDataParam, formDataParam.id)
					.then(() => {
						onClose()
						emit('successful')
					})
